...
namespace esphome
{
    namespace idasen_desk_controller
    {
        ...
        public:
            ...
            void set_desk_moving_binary_sensor(binary_sensor::BinarySensor *desk_moving_binary_sensor) { desk_moving_binary_sensor_ = desk_moving_binary_sensor; }
            void set_desk_connection_binary_sensor(binary_sensor::BinarySensor *desk_connection_binary_sensor) { desk_connection_binary_sensor_ = desk_connection_binary_sensor; }
